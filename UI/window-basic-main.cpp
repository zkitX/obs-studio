...
#undef SET_VISIBILITY
	...
	mediaScroll->setProperty("themeID", "mediaControlWidgets");
	mediaControlsContainer = new QWidget(mediaScroll);
	mediaControlsContainer->setProperty("themeID", "mediaControlWidgets");
